...
export function addRoutes(): void {
  ...
  app.get(
    "/api/users/@me",
    middleware.auth.requireAuthenticatedUser,
    api.http(api.users.me)
  )
  app.get(
    "/api/users/@me/licenses",
    middleware.auth.requireAuthenticatedUser,
    api.http(api.users.myLicenses)
  )
  app.get(
    "/api/users/@me/discord/request",
    middleware.auth.requireAuthenticatedUser,
    api.http(api.verification.discordRequest)
  )
  ...
  app.post(
    ...
    api.http(api.users.resetPasswordRequest)
  )
  app.post(
    "/api/reset/password/confirmation",
    api.http(api.users.resetPasswordConfirmation)
  )
  ...
  app.get(
    "/api/admin/users/:id",
    middleware.auth.requireAPICredentials,
    api.http(api.users.read)
  )
  app.get(
    "/api/admin/users/username/:username",
    middleware.auth.requireAPICredentials,
    api.http(api.users.readByUsername)
  )
  app.post(
    "/api/admin/users/:id/license",
    middleware.auth.requireAPICredentials,
    api.http(api.licenses.add)
  )
  ...
  app.get(
    "/api/users/@me/discord/confirmation",
    api.render(api.verification.discordConfirmation)
  )
}
